...
// ObscureTooltips.LOGGER.error("Failed to create Obscuria config directory",
// var4);
// }

// ModLoadingContext.get().registerConfig(Type.CLIENT,
// ObscureTooltipsConfig.Client.CLIENT_SPEC,
...
// displayArmorModels = BUILDER.worldRestart().define("displayArmorModels",
// true);
// displayToolModels = BUILDER.worldRestart().define("displayToolsModels",
// true);
// BUILDER.pop();
