...
public final class TooltipsRegistry {
   ...
   public static final TooltipElement<ColorRectPanel> PANEL_COLOR_RECT = registerPanel(key("color_rect"), (params) -> {
      return new ColorRectPanel(FactoryHelper.color(params, "back_top_color"),
            ...
            FactoryHelper.color(params, "border_bottom_color"), FactoryHelper.color(params, "slot_color"));
   });
   ...
   public static final TooltipElement<RimLightingEffect> EFFECT_ENCHANTMENT = registerEffect(key("rim_lighting"),
         (params) -> {
   ...
   public static <T extends TooltipPanel> TooltipElement<T> registerPanel(ResourceLocation key,
         TooltipElement<T> factory) {
      PANELS.put(key, factory);
      return factory;
   }

   public static <T extends TooltipFrame> TooltipElement<T> registerFrame(ResourceLocation key,
         TooltipElement<T> factory) {
      FRAMES.put(key, factory);
      return factory;
   }

   public static <T extends TooltipIcon> TooltipElement<T> registerIcon(ResourceLocation key,
         TooltipElement<T> factory) {
      ICONS.put(key, factory);
      return factory;
   }

   public static <T extends TooltipEffect> TooltipElement<T> registerEffect(ResourceLocation key,
         TooltipElement<T> factory) {
