...
// import
// dev.quentintyr.embellishedtooltips.client.style.effect.RimLightingEffect;
...
// import
// dev.quentintyr.embellishedtooltips.client.style.icon.ConstantRotationIcon;
// import
// dev.quentintyr.embellishedtooltips.client.style.icon.DescentComplexIcon;
...
// private static final HashMap<ResourceLocation, TooltipElement<? extends
// TooltipPanel>> PANELS = new HashMap();
// private static final HashMap<ResourceLocation, TooltipElement<? extends
// TooltipFrame>> FRAMES = new HashMap();
// private static final HashMap<ResourceLocation, TooltipElement<? extends
// TooltipIcon>> ICONS = new HashMap();
// private static final HashMap<ResourceLocation, TooltipElement<? extends
// TooltipEffect>> EFFECTS = new HashMap();
// public static final TooltipElement<ColorRectPanel> PANEL_COLOR_RECT =
// registerPanel(key("color_rect"), (params) -> {
// return new ColorRectPanel(FactoryHelper.color(params, "back_top_color"),
// FactoryHelper.color(params, "back_bottom_color"), FactoryHelper.color(params,
// "border_top_color"),
...
// return new TextureFrame(new
// ResourceLocation(params.get("texture").getAsString()));
// });
...
// public static <T extends TooltipPanel> TooltipElement<T>
// registerPanel(ResourceLocation key,
// TooltipElement<T> factory) {
// PANELS.put(key, factory);
// return factory;
// }

// public static <T extends TooltipFrame> TooltipElement<T>
// registerFrame(ResourceLocation key,
// TooltipElement<T> factory) {
// FRAMES.put(key, factory);
// return factory;
// }

// public static <T extends TooltipIcon> TooltipElement<T>
// registerIcon(ResourceLocation key,
// TooltipElement<T> factory) {
// ICONS.put(key, factory);
// return factory;
// }

// public static <T extends TooltipEffect> TooltipElement<T>
// registerEffect(ResourceLocation key,
// TooltipElement<T> factory) {
// EFFECTS.put(key, factory);
// return factory;
// }

// public static Optional<TooltipPanel> buildPanel(ResourceLocation key,
// JsonObject params) {
// ResourceLocation factory = FactoryHelper.key(params, "factory");

// try {
// return Optional.of((TooltipPanel) ((TooltipElement)
// PANELS.get(factory)).build(params));
// } catch (Exception var4) {
// ObscureTooltips.LOGGER.error(BUILDER, "Failed to build custom Panel <{}> from
// factory <{}>", key, factory);
...
// public static Optional<TooltipFrame> buildFrame(ResourceLocation key,
// JsonObject params) {
// ResourceLocation factory = FactoryHelper.key(params, "factory");

// try {
// return Optional.of((TooltipFrame) ((TooltipElement)
// FRAMES.get(factory)).build(params));
// } catch (Exception var4) {
// ObscureTooltips.LOGGER.error(BUILDER, "Failed to build Frame <{}> from
// factory <{}>", key, factory);
// var4.printStackTrace();
// return Optional.empty();
// }
...
// public static Optional<TooltipIcon> buildIcon(ResourceLocation key,
// JsonObject params) {
// ResourceLocation factory = FactoryHelper.key(params, "factory");

// try {
// return Optional.of((TooltipIcon) ((TooltipElement)
// ICONS.get(factory)).build(params));
// } catch (Exception var4) {
// ObscureTooltips.LOGGER.error(BUILDER, "Failed to build Icon <{}> from factory
// <{}>", key, factory);
// var4.printStackTrace();
// return Optional.empty();
// }
...
// public static Optional<TooltipEffect> buildEffect(ResourceLocation key,
// JsonObject params) {
// ResourceLocation factory = FactoryHelper.key(params, "factory");

// try {
// return Optional.of((TooltipEffect) ((TooltipElement)
// EFFECTS.get(factory)).build(params));
// } catch (Exception var4) {
// ObscureTooltips.LOGGER.error(BUILDER, "Failed to build Effect <{}> from
// factory <{}>", key, factory);
// var4.printStackTrace();
// return Optional.empty();
// }
