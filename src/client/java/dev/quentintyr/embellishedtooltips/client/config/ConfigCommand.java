                                ...
                                .then(ClientCommandManager.literal("config")
                                                ...
                                                .then(ClientCommandManager.literal("status")
                                                                .executes(context -> {
                                                                        ...
                                                                        context.getSource().sendFeedback(
                                                                                        Text.literal("  Speed: "
                                                                                                        + config.animations.animationSpeed
                                                                                                        + "x"));
                                                                        context.getSource().sendFeedback(
                                                                                        Text.literal("  Rotation: "
                                                                                                        + config.animations.enableIconRotation));
                                                                        context.getSource().sendFeedback(
                                                                                        Text.literal("  Scaling: "
                                                                                                        + config.animations.enableIconScaling));
                                                                        context.getSource().sendFeedback(
                                                                                        Text.literal("  Timeout: "
                                                                                                        + config.animations.reHoverTimeoutMs
                                                                                                        + "ms"));
                                                                        context.getSource().sendFeedback(
                                                                                        Text.literal("Rendering:"));
                                                                        context.getSource().sendFeedback(
                                                                                        Text.literal("  Enabled: "
                                                                                                        + config.rendering.enableCustomTooltips));
                                                                        context.getSource().sendFeedback(
                                                                                        Text.literal("  Armor Preview: "
                                                                                                        + config.rendering.enableArmorPreview));
                                                                        context.getSource().sendFeedback(
                                                                        ...
                                                                        context.getSource().sendFeedback(
                                                                                        Text.literal("  Stat Icons: "
                                                                                                        + config.rendering.showStatIcons));
                                                                        context.getSource().sendFeedback(
                                                                                        Text.literal("  Scale: "
                                                                                                        + config.rendering.tooltipScale
                                                                                                        + "x"));
                                                                        context.getSource().sendFeedback(
                                                                                        Text.literal("Compatibility:"));
                                                                        context.getSource().sendFeedback(
                                                                                        Text.literal("  Inventory: "
                                                                                                        + config.compatibility.enableInInventory));
                                                                        context.getSource().sendFeedback(
                                                                                        Text.literal("  Containers: "
                                                                                                        + config.compatibility.enableInContainers));
                                                                        context.getSource().sendFeedback(
                                                                                        Text.literal("  Creative: "
                                                                                                        + config.compatibility.enableInCreative));
                                                                        return 1;
                                                                }))
