...
// public CircleParticle(float lifetime, Vec2 start, Vec2 end, int startColor,
// int endColor, float radius) {
// super(lifetime);
...
// context.context().m_280091_().m_6299_(RenderType.m_286086_());
// vertexconsumer.m_252986_(matrix4f, 0.0F, 0.0F,
