...
public class TextureFrame implements TooltipFrame {
   ...
   public void render(TooltipContext context, Vec2 pos, Point size) {
      ...
      context.blit(this.TEXTURE, (int)pos.f_82470_ + size.x / 2 - 30, (int)pos.f_82471_ + size.y - 6, 10, 16, 60, 16, 80, 32);
      ...
      context.blit(this.TEXTURE, (int)pos.f_82470_ + size.x - 5, (int)pos.f_82471_ + size.y - 5, 70, 22, 10, 10, 80, 32);
   }
}
