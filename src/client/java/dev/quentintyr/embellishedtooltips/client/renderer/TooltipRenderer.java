...
public final class TooltipRenderer {
    ...
    // public static boolean render(TooltipContext renderer, ItemStack stack, Font
    // font,
    ...
    // Vector2ic rawPos = positioner.m_262814_(renderer.width(), renderer.height(),
    // x, y, size.x, size.y);
    ...
    // var10000.m_280430_(Minecraft.m_91087_().f_91062_, summaryField, var10003,
    // (int) pos.f_82471_ + 13, -11513776);
    // renderer.drawManaged(() -> {
    ...
    // && (Boolean) ObscureTooltipsConfig.Client.displayArmorModels.get()) {
    ...
    // Axis.f_252436_.m_252977_((float) ((double) System.currentTimeMillis() /
    ...
    // renderer.drawManaged(() -> {
    // renderStyle.renderBack(renderer, pos.m_165910_(new Vec2(-55.0F, 0.0F)), new
    // Point(30, 60), false);
    // });
    ...
    // return Component.m_237115_("rarity." + stack.m_41791_().name().toLowerCase()
    // + ".name");
    // }

    // private static Point calculateSize(Font font, List<ClientTooltipComponent>
    // components, Component summaryField) {
    // int width = 26 + ((ClientTooltipComponent)
    // components.get(0)).m_142069_(font);
    // int height = 14;

    // ClientTooltipComponent component;
    // for (Iterator var5 = components.iterator(); var5.hasNext(); height +=
    // component.m_142103_()) {
    ...
    // private static void renderText(TooltipContext renderer, Font font,
    // List<ClientTooltipComponent> components,
    // Vec2 pos) {
    // int offset = (int) pos.f_82471_ + 3;

    // for (int i = 0; i < components.size(); ++i) {
    // ClientTooltipComponent component = (ClientTooltipComponent)
    // components.get(i);
    ...
    // entityrenderdispatcher.m_114384_(renderStand, 0.0D, 0.0D, 0.0D, 0.0F, 1.0F,
    // renderer.pose(),
    ...
    // renderStand = new ArmorStand(EntityType.f_20529_,
    ...
    // reset();
    // renderStack = stack;
    // renderStyle = (TooltipStyle) StyleManager.getStyleFor(stack).orElse((Object)
    // null);
    // if (renderStyle != null) {
    // renderStyle.reset();
    // }
