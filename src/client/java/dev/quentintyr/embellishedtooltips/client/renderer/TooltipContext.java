...
// public void fillGradient(int x, int y, int width, int height, int start, int
// end) {
// this.context().m_280024_(x, y, x + width, y + height, start, end);
// }

// public void blit(ResourceLocation texture, int x, int y, int xTex, int yTex,
// int width, int height, int widthTex,
// int heightTex) {
// this.context().m_280163_(texture, x, y, (float) xTex, (float) yTex, width,
// height, widthTex, heightTex);
// }
...
// public void pushAndMul(Quaternionf quaternionf, Runnable before, Runnable
// after) {
// this.context().m_280168_().m_85836_();
...
// return (float) Math.atan2((double) (to.f_82471_ - from.f_82471_), (double)
// (to.f_82470_ - from.f_82470_));
// }
